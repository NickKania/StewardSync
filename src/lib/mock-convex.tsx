// Mock Convex client and provider for testing without backend
...
export function MockConvexProvider({
  ...
  return (
    <MockConvexContext.Provider value={{ client }}>
      {children}
...
// Mock useQuery hook
export function useMockQuery<T>(query: any, args?: any): T | undefined {
...
export function useMockMutation(mutation: any) {
...
export const mockConvexClient = new MockConvexReactClient("mock://convex");
